...
namespace {
    ...
    /** @brief Stored CAIN joint E_gamma-theta_gamma reference for the weak-field single-electron
     * case. */
    ...
    /** @brief Stored CAIN energy-spectrum reference for the finite-beam plus energy-spread
     * benchmark. */
    ...
    /** @brief Stored CAIN joint-spectrum reference for the finite-beam plus energy-spread
     * benchmark. */
    ...
    /** @brief Stored CAIN energy-spectrum reference for the overlap-restricted finite-beam
     * benchmark. */
    ...
    /**
     * @brief Regenerate one finite-beam OPALX histogram through the standalone benchmark
     * executable.
     *
