...
# AddOPALXTest.cmake
#
# Defines a helper macro `add_opalx_test()` to create a unit test executable. It links to OPALX and
...
#   [NUM_PROCS <N>]                    # default: OPALX_DEFAULT_TEST_PROCS (1)
...
function(add_opalx_test TEST_NAME)
  ...
  if("${TEST_NAME}" IN_LIST OPALX_DISABLED_TEST_LIST)
  ...
  if(TEST_NUM_PROCS)
    ...
    set(_procs "${OPALX_DEFAULT_TEST_PROCS}")
  endif()
  ...
  if(TEST_NO_MPI)
    ...
    elseif(TEST_REQUIRE_MPI)
      ...
      message(STATUS "add_opalx_test(${TEST_NAME}): MPI not found; running without mpiexec")
      set(_final_cmd ${_launched_cmd})
    endif()
  endif()
