...
public:
    ...
    enum VirtualMemory {
        ...
        VMPIN,  // VmPin: Pinned memory size (since Linux 3.2).  These are pages that can't be moved
        ...
        VMSWAP  // VmSwap: Swapped-out virtual memory size by  anonymous  private  pages;  shmem
