...
bool Table::canReplaceBy(Object* /*newObject*/) { return false; }
...
const std::string Table::getCategory() const { return "TABLE"; }

bool Table::shouldTrace() const { return true; }

bool Table::shouldUpdate() const { return true; }
