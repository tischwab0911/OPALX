...
OpalMultipole::OpalMultipole()
    ...
    itsAttr[DKN] =
        Attributes::makeRealArray("DKN", "Normalised multipole strengths errors(normal) in m^(-k)");
    itsAttr[KS] =
        Attributes::makeRealArray("KS", "Normalised multipole strengths (skew) in m^(-k)");
    itsAttr[DKS] =
        Attributes::makeRealArray("DKS", "Normalised multipole strength errors (skew) in m^(-k)");
