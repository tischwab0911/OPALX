...
inline std::shared_ptr<Component> ClassicField::getElement() { return element_m; }

inline std::shared_ptr<const Component> ClassicField::getElement() const { return element_m; }

inline double ClassicField::getLength() const { return end_m - start_m; }

inline const double& ClassicField::getStart() const { return start_m; }

inline const double& ClassicField::getEnd() const { return end_m; }

inline const bool& ClassicField::isOn() const { return is_on_m; }

inline void ClassicField::setStart(const double& z) { start_m = z; }

inline void ClassicField::setEnd(const double& z) { end_m = z; }

inline BoundingBox ClassicField::getBoundingBoxInLabCoords() const {
