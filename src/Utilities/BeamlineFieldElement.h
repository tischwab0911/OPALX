...
inline std::shared_ptr<Component> BeamlineFieldElement::getElement() {
    return element_m;
}
...
inline double BeamlineFieldElement::getLength() const {
    return end_m - start_m;
}

inline const double &BeamlineFieldElement::getStart() const {
    return start_m;
}

inline const double &BeamlineFieldElement::getEnd() const {
    return end_m;
}

inline const bool &BeamlineFieldElement::isOn() const {
    return is_on_m;
}

inline void BeamlineFieldElement::setStart(const double & z) {
    start_m = z;
}

inline void BeamlineFieldElement::setEnd(const double & z) {
    end_m = z;
}
