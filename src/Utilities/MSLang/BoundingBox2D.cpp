...
namespace mslang {
    ...
    void BoundingBox2D::writeGnuplot(std::ostream& out) const {
        std::vector<Vector_t<double, 3>> pts(
                {Vector_t<double, 3>(center_m[0] + 0.5 * width_m, center_m[1] + 0.5 * height_m, 0),
                 ...
                 Vector_t<double, 3>(center_m[0] - 0.5 * width_m, center_m[1] - 0.5 * height_m, 0),
                 Vector_t<double, 3>(
                         center_m[0] + 0.5 * width_m, center_m[1] - 0.5 * height_m, 0)});
    ...
    void BoundingBox2D::print(std::ostream& out) const {
        out << std::setw(18) << center_m[0] - 0.5 * width_m << std::setw(18)
            << center_m[1] - 0.5 * height_m << std::setw(18) << center_m[0] + 0.5 * width_m
            << std::setw(18) << center_m[1] + 0.5 * height_m << std::endl;
    }
