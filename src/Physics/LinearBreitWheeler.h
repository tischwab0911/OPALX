...
struct SamplingKernel {
    double highEnergyPhotonEnergyGeV = 0.0;  ///< Incoming high-energy photon energy in the lab frame [GeV].
    double laserPhotonEnergyGeV = 0.0;  ///< Incoming laser-photon energy in the lab frame [GeV].
    Vector_t<double, 3> highEnergyDirection = Vector_t<double, 3>(0.0);  ///< Normalized incoming high-energy photon direction.
    Vector_t<double, 3> laserDirection = Vector_t<double, 3>(0.0);  ///< Normalized incoming laser-photon direction.
    double invariantSGeV2 = 0.0;  ///< Two-photon invariant @f$s@f$ in GeV^2.
    double pairBetaCM = 0.0;  ///< Outgoing lepton speed @f$\beta = \sqrt{1 - 4m_e^2/s}@f$ in the pair CM frame.
    double cmLorentzGamma = 0.0;  ///< Lorentz factor of the CM frame relative to the laboratory frame.
    Vector_t<double, 3> cmVelocity = Vector_t<double, 3>(0.0);  ///< Dimensionless CM boost velocity.
 ...
 */
struct SampledEvent {
    double scatteringCosineCM = 0.0;  ///< Center-of-momentum scattering cosine @f$\cos\theta@f$.
    double azimuthCM = 0.0;  ///< Center-of-momentum azimuth @f$\phi@f$ in rad.
    double electronEnergyLabGeV = 0.0;  ///< Outgoing electron energy in the lab frame [GeV].
    double positronEnergyLabGeV = 0.0;  ///< Outgoing positron energy in the lab frame [GeV].
    Vector_t<double, 3> electronMomentumLabGeV = Vector_t<double, 3>(0.0);  ///< Outgoing electron three-momentum in the lab frame [GeV/c].
    Vector_t<double, 3> positronMomentumLabGeV = Vector_t<double, 3>(0.0);  ///< Outgoing positron three-momentum in the lab frame [GeV/c].
};
