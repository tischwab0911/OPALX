...
namespace Physics {
    namespace MuonDecay {
        ...
        KOKKOS_INLINE_FUNCTION constexpr double maxElectronEnergy() { return Physics::m_mu / 2.0; }
        ...
        /// Unnormalized Michel spectrum: \f$ f(x) = 2 x^2 (3 - 2x) \f$ for \f$ x \in [x_\text{min},
        /// 1] \f$.
        ...
        KOKKOS_INLINE_FUNCTION constexpr double michelUpperBound() { return 2.0; }
