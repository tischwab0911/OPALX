    ...
    namespace LinearCompton {
        ...
        struct SamplingKernel {
            double electronTotalEnergyGeV =
                    0.0;  ///< Incoming electron total energy in the lab frame [GeV].
            double laserPhotonEnergyGeV =
                    0.0;  ///< Incoming laser-photon energy in the lab frame [GeV].
            Vector_t<double, 3> beamDirection = Vector_t<double, 3>(
                    0.0);  ///< Normalized incoming electron direction in the lab frame.
            Vector_t<double, 3> laserDirection = Vector_t<double, 3>(
                    0.0);  ///< Normalized incoming laser direction in the lab frame.
            double incomingPhotonEnergyERFGeV =
                    0.0;  ///< Laser-photon energy after Lorentz transforming into the electron rest
                          ///< frame [GeV].
            double rejectionUpperBoundSolidAngleERF =
                    0.0;  ///< Conservative upper envelope for @f$d\sigma/d\Omega^*@f$ used by the
                          ///< rejection sampler.
        };
        ...
        struct SampledEvent {
            double scatteringCosineERF =
                    0.0;              ///< Rest-frame polar scattering cosine @f$\cos\Theta^*@f$.
            double azimuthERF = 0.0;  ///< Rest-frame azimuth @f$\phi^*@f$ around the
                                      ///< incoming-photon axis [rad].
            double scatteredPhotonEnergyERFGeV =
                    0.0;  ///< Outgoing photon energy in the electron rest frame [GeV].
            double scatteredPhotonEnergyLabGeV =
                    0.0;  ///< Outgoing photon energy in the laboratory frame [GeV].
            Vector_t<double, 3> scatteredPhotonDirectionLab = Vector_t<double, 3>(
                    0.0);  ///< Normalized outgoing photon direction in the laboratory frame.
        };
         ...
         * @param incomingPhotonEnergyERFGeV Incoming photon energy in the electron rest frame in
         * GeV.
        ...
        /**
         * @brief Unpolarized Klein-Nishina differential cross section in the scattered-photon
         * energy.
         *
         ...
         * @param incomingPhotonEnergyERFGeV Incoming photon energy in the electron rest frame in
         * GeV.
         * @param scatteredPhotonEnergyERFGeV Scattered photon energy in the electron rest frame in
         * GeV.
