...
namespace ParticleBinning {
    ...
    public:
         ...
         */
        void print() { globalBinHisto_m.printPythonArrays(); }
...
// Check number of GPUs (CUDA devices)
            ...
            msg << "CUDA Enabled: Rank " << rank << " sees " << num_gpus << " GPU(s) available."
                << endl;
            ...
            msg << "Binning cost function parameters: alpha = " << binningAlpha_m
        ...
        /**
         * @brief Applies a Lorentz transformation to a given vector field based on particle
         * velocities.
         *
         ...
         *
         * @details
         * - **Gamma Factor Calculation:** The gamma factor is derived from the velocity components
         * of particles. For a given particle velocity \(v\), the gamma factor is computed as:
         *   \[
         *   \gamma = \frac{1}{\sqrt{1 - \vec{v} \cdot \vec{v}}}
         *   \]
         *   where \(\vec{v}\) is the velocity vector of a particle.
         *
         * - **Field Transformation:** After computing the gamma factor, each component of the field
         * is multiplied by the corresponding gamma factor.
         *
         * ### Example Usage:
         * ```cpp
         ...
         * ```
         *
         * @note This function should not be used inside OPAL-X, since it makes assumptions
         * regarding the actual particle bunch. It is just for testing during development.
         */
