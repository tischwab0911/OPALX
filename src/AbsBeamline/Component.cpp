...
const ElementBase& Component::getDesign() const { return *this; }
...
void Component::goOnline(const double&) { online_m = true; }

void Component::goOffline() { online_m = false; }

bool Component::Online() { return online_m; }
 ...
 */
bool Component::apply() { return false; }
