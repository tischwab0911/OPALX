...
Title::Title(const std::string& name, Title* parent) : Action(name, parent) {}

Title::~Title() {}

Title* Title::clone(const std::string& name) { return new Title(name, this); }
...
void Title::parse(Statement& statement) { parseShortcut(statement); }
