...
Matrix3D& Matrix3D::operator*=(const Matrix3D& rhs) { return (*this = *this * rhs); }
...
Matrix3D Matrix3D::Identity() { return Matrix3D(); }

bool Matrix3D::isIdentity() const {
    return (m[0][0] == 1.0) && (m[0][1] == 0.0) && (m[0][2] == 0.0) && (m[1][0] == 0.0)
