...
void Vector3D::clear() { v[0] = v[1] = v[2] = 0.0; }

void Vector3D::getComponents(double& x, double& y, double& z) const {
    x = v[0];
    y = v[1];
    z = v[2];
}

bool Vector3D::isZero() const { return v[0] == 0.0 && v[1] == 0.0 && v[2] == 0.0; }
